...
// ****lab5 code begin****
    hdrSector=sector;
    printf("OpenFile initializes, sector number is %d\n",hdrSector);
// ****lab5 code end****
    hdr = new FileHeader;
...
{
// ****lab5 code begin****
    printf("Reading, sector number is %d\n", hdrSector);
    int result = ReadAt(into, numBytes, seekPosition);
    seekPosition += result;
    hdr->setLastOpenTime();
    printf("lastOpenTime is %s\n",hdr->getLastOpenTime());
...
{
// ****lab5 code begin****
    printf("Writing, sector number is %d\n", hdrSector);
    int result = WriteAt(into, numBytes, seekPosition);
    seekPosition += result;
    hdr->setLastOpenTime();
    hdr->setUpdateTime();
    printf("lastOpenTime is %d\n",hdr->getLastOpenTime());
    printf("updateTime is %d\n",hdr->getUpdateTime());
    hdr->WriteBack(hdrSector);
// ****lab5 code end****
    return result;
}
